                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav menu ms-auto g-1">
                                <li class="nav-item">
                                    <a class="nav-link option-menu" href="./officialrules.html">Official Rules</a>
                                </li>
                                <li class="nav-item menu-opcion">
                                    <a class="nav-link option-menu" href="./tilescounter.html">Tiles Counter</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link option-menu" href="./carcassonnetimer.html">Timers</a>
                                </li>
                                <li class="nav-item option-tournament">
                                    <a class="nav-link option-menu" href="./createTournament.html">Tournament</a>
